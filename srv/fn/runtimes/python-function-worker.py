...
def _run_waitable_in_background(waitable, request_id: str):
    try:
        _resolve_awaitable(waitable)
    except Exception as exc:
        _json_log("wait_until_rejection", request_id=request_id, error=str(exc))


def _schedule_background_waitables(waitables: list[object], request_id: str):
...
def _handle(payload: dict) -> dict:
    ...
    handler_dir = str(handler_path_p.parent)
