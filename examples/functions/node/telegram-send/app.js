...
exports.handler = async (event) => {
  ...
  // Prefer function-scoped env, but allow falling back to process env for local/dev.
  // This helps when secrets live in docker-compose/.env and you don't want to write them to fn.env.json.
