...
> **Note:** Step 4 (Rust) requires enabling the Rust runtime, which is not
> included by default in native mode:
>
> ```bash
> FN_RUNTIMES=python,node,php,lua,rust ./bin/fastfn dev examples/functions
> ```
