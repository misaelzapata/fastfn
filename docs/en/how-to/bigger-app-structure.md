...
- if discovery behavior feels ambiguous, review [Zero-config routing](./zero-config-routing.md) for the warning rules around depth, reserved prefixes, and handler selection
