...
> Internals del runtime: FastFN habla con `php-daemon.php`, y ese daemon delega cada handler a procesos hijos aislados `php-worker.php`. Esa división es interna y evita fugas entre funciones PHP.
El runtime PHP ya esta implementado. Usa esta plantilla para `handler.php`.
