...
Para ver los casos limites exactos de discovery, consulta
[Enrutamiento Zero-Config](../como-hacer/zero-config-routing.md): ahi se documentan el
límite fijo de 6 niveles, los prefijos reservados, los warnings por segmentos ASCII y la
seleccion determinista cuando existen varios entry files compatibles.
