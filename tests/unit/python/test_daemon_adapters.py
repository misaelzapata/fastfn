#!/usr/bin/env python3
"""Tests for python-daemon.py invoke adapters (AWS Lambda, Cloudflare Worker, etc.)."""
import json
import os
import tempfile
...
python_daemon = load_module(PY_DAEMON_PATH)
...
""".strip()
        ...
        try:
            ...
            assert state.get("unresolved_imports") == ["PIL"]
