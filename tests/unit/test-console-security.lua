...
local function main()
  ...
  write(root .. "/functions/python/safe/handler.py", "def handler(event):\n    return {'status':200,'headers':{'Content-Type':'application/json'},'body':'{}'}\n")
  ...
  os.execute("rm -f " .. string.format("%q", root .. "/functions/python/safe/handler.py"))
  os.execute("ln -sf " .. string.format("%q", outside) .. " " .. string.format("%q", root .. "/functions/python/safe/handler.py"))
